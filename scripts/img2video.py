...
def parse_args():
    ...
    parser.add_argument('--input-dir', type=str, default='./runs/pred_pic/bisenet_best_resnet18_apollos/label/', 
    ...
    parser.add_argument('--w', type=int, default=3384)
    parser.add_argument('--h', type=int, default=1010)
...
if __name__ == '__main__':
    ...
    out = cv2.VideoWriter(filename=outname, fourcc=cv2.VideoWriter_fourcc(*'X264'), fps=args.fps, frameSize=(args.w,args.h))
